...
const TASK_PATTERNS = [
  // Code patterns
  {
    tokens: ["implement", "create", "build", "add", "write code", "refactor", "debug"],
    agent: "coder",
  },
  {
    tokens: ["test", "tests", "spec", "coverage", "unit test", "integration test"],
    agent: "tester",
  },
  ...
  {
    tokens: ["deploy", "docker", "ci", "cd", "ci/cd", "pipeline", "infrastructure", "devops"],
    agent: "devops",
  },
];
